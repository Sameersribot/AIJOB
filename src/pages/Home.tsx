      ...
      <div className="bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <Link
              to="/pricing"
              className="group bg-white text-black px-8 py-4 rounded-lg flex items-center space-x-2 hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            >
