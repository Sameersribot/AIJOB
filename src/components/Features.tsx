...
//                   <feature.icon 
//                     className={`h-12 w-12 relative ${activeFeature === index ? 'text-white animate-bounce' : 'text-black'}`} 
//                   />
//                 </div>
//                 <h3 className="text-xl font-semibold mb-4">{feature.title}</h3>
//                 <p className={`leading-relaxed ${activeFeature === index ? 'text-gray-300' : 'text-gray-600'}`}>
//                   {feature.description}
//                 </p>

//                 {/* Feature Demo Animation */}
//                 <div className={`mt-6 p-4 rounded-lg ${activeFeature === index ? 'bg-white/10' : 'bg-white'}`}>
...
//                 <div className="w-16 h-16 mx-auto bg-black text-white rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
