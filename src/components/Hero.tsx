...
//                 <Bot className="h-20 w-20 text-black relative animate-bounce" />
...
//             <h1 className="text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 leading-tight py-1">
...
//               <Link
//                 to="/pricing"
//                 className="group relative inline-flex items-center justify-center px-8 py-4 font-bold text-white transition-all duration-200 bg-black rounded-lg hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
//               >
...
//                 className="relative inline-flex items-center justify-center px-8 py-4 font-bold transition-all duration-200 bg-white border-2 border-black rounded-lg hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
//               >
//                 See How It Works
//               </button>
//             </div>
...
//             <div className="bg-white/50 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-gray-100 transform hover:scale-105 transition-transform">
//               <div className="flex items-center space-x-4 mb-4">
//                 <div className="w-3 h-3 rounded-full bg-red-500"></div>
//                 <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
//                 <div className="w-3 h-3 rounded-full bg-green-500"></div>
//               </div>
//               <div className="font-mono text-sm bg-black text-green-400 p-4 rounded-lg h-32 flex items-center justify-center">
...
//                 <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800">2x</div>
//                 <div className="text-sm text-gray-600 mt-1">Success Rate</div>
//               </div>
//               <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
//                 <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">10k+</div>
//                 <div className="text-sm text-gray-600 mt-1">Jobs Searched</div>
//               </div>
//               <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
//                 <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-purple-800">1000+</div>
//                 <div className="text-sm text-gray-600 mt-1">Users</div>
//               </div>
//             </div>

//             {/* Achievement Cards - Replacing Trust Badges */}
//             <div className="grid grid-cols-3 gap-4">
//               {achievements.map((achievement) => {
//                 const Icon = achievement.icon;
//                 return (
//                   <div key={achievement.title} className="bg-white/80 backdrop-blur rounded-xl p-6 text-center group hover:bg-black hover:text-white transition-all duration-300">
//                     <Icon className="h-8 w-8 mx-auto mb-3 group-hover:text-white transition-colors" />
//                     <h3 className="font-semibold mb-1 text-sm">{achievement.title}</h3>
//                     <p className="text-xs text-gray-500 group-hover:text-gray-300">{achievement.description}</p>
//                   </div>
//                 );
//               })}
